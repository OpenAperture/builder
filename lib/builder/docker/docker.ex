...
defmodule OpenAperture.Builder.Docker do
  ...
  defp read_output_file(docker_output_file) do
    case File.exists?(docker_output_file) do
      true -> File.read!(docker_output_file)
      _    -> raise "Unable to read docker output file #{docker_output_file} - file does not exist!"
    end
  end
end
